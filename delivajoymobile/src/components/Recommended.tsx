...
const cardWidth = width * 0.95; // 95% of screen width

interface SpecialOfferProps {
  index: number;
}

const Recommended: React.FC<SpecialOfferProps> = ({ index }) => {
  const RecommendedOffers = [
    ...
    },
    {
      ...
      imageUrl: require('../assets/Attracting-new-salon-customers.jpg'), // Static image
    },
    {
      title: "The Hair Loft",
  ...
  const offer = RecommendedOffers[index % RecommendedOffers.length];
...
const styles = StyleSheet.create({
  ...
  arrowButton: {
    backgroundColor: 'rgba(165, 76, 216, 1)',
    borderRadius: 50,
    padding: 8,
  },
  arrowIcon: {
