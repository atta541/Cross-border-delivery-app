...
export class WebscrapperService {
  constructor(
    // Import all services here via constructor injection
    // private readonly blossomFloralsService: BlossomFloralsService,
    private readonly almirahService: AlmirahService,
    private readonly sanaSafinazService: sanasafinazService,
    private readonly bundukhansweetsService: BundukhansweetsService,
    private readonly layersService: LayersService,
  ) {}

  async startAllScrapers() {
    console.log('🚀 Starting all scrapers manually...');
    // await this.blossomFloralsService.scrapeBlossomFloralsProducts();
    await this.almirahService.scrapeAlmirahProducts();
    await this.sanaSafinazService.scrapeSanaSafinazProducts();
    await this.bundukhansweetsService.scrapeSweets();
    await this.layersService.scrapeAllCategories();
